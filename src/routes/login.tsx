        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="flex justify-center gap-4 lg:justify-start">
            <Button variant="outline" size="icon" className="rounded-full h-12 w-12" asChild>
              <a href={`${API_URL}/auth/login/google`} aria-label="Sign in with Google">
                <GoogleIcon className="h-6 w-6" />
              </a>
            </Button>
            <Button variant="outline" size="icon" className="rounded-full h-12 w-12" asChild>
              <a href={`${API_URL}/auth/login/github`} aria-label="Sign in with GitHub">
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center">
                      ...
                      <Link to="/reset-password" className="ml-auto inline-block text-sm underline text-muted-foreground hover:text-primary">
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-slate-900">
        ...
        <div className="absolute bottom-10 left-10 right-10 bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-white/10">
          <div className="space-y-3">
            <h3 className="text-2xl font-bold text-white tracking-tight">FastAPI Auth Platform</h3>
            <p className="text-slate-200">
              A production-ready authentication template demonstrating state-of-the-art security patterns, including stateless JWT rotation and comprehensive OAuth integration.
            </p>
            <div className="flex items-center gap-2 mt-4 text-sm font-medium text-emerald-400">
